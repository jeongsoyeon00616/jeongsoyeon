...
export const PROJECTS: Project[] = [
  {
    ...
    longDescription: '은은한 베이지 톤을 베이스로 우드를 더해 아늑한 분위기를 강조한 공간이다. 집의 중심인 주방에는 필름 대신 천연 무늬목을 적용해 자연 소재의 질감이 드러나도록 계획하였으며, 커피를 즐기는 고객의 라이프스타일을 반영해 포켓도어 홈바를 구성하였다. 내부는 헤어라인 PET 마감과 하부 조명을 적용해 디테일을 더하고, 천장 매립형 후드를 통해 시각적인 간섭을 최소화하였다. 또한 각 방에도 맞춤형 가구 설계를 적용해 공간 전반의 완성도를 높였다.',
  ...
  },
  {
    ...
    longDescription: '첫 메인 디자인 프로젝트로, 기존 구조를 바탕으로 주방–다이닝–거실로 이어지는 흐름 속에서 공간이 더욱 넓고 시원하게 느껴지도록 가구를 배치하였다. 다이닝장, 거실 장식장, 드레스룸 오픈장 등 곳곳에 세밀한 디테일을 더해 공간의 완성도를 높였으며, 블루 계열 포인트를 적용해 고객의 취향을 자연스럽게 반영하였다.',
  ...
  },
  {
    ...
    longDescription: '고객의 뚜렷한 취향을 바탕으로 자재와 디테일의 조합에 집중한 공간이다. 주방의 빅슬랩 타일을 중심으로 전체 컬러와 소재의 밸런스를 맞추고, 창가에는 무늬목 홈바 테이블과 와인잔 거치대를 계획해 뷰를 즐길 수 있도록 구성하였다. 거실에는 띄움장과 선반을 통해 확장감을 더했으며, 안방에는 상부 개폐형 화장대와 커스텀 옷걸이봉을 적용해 차별화된 디테일을 완성하였다.',
