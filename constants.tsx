...
export const PROJECTS: Project[] = [
  {
    ...
    galleryUrls: [
      ...
      '/assets/projects/1. 개포우성/3.jpg',
      '/assets/projects/1. 개포우성/4.jpg',
      '/assets/projects/1. 개포우성/5.jpg'
    ],
  ...
  },
  {
    ...
    title: '용산파크타워',
    category: 'Residential',
    imageUrl: '/assets/projects/2. 용산파크타워/2.JPG',
    galleryUrls: [
      '/assets/projects/2. 용산파크타워/1.JPG',
      '/assets/projects/2. 용산파크타워/2.JPG',
      '/assets/projects/2. 용산파크타워/3.jpg',
      '/assets/projects/2. 용산파크타워/4.jpg',
      '/assets/projects/2. 용산파크타워/5.jpg',
      '/assets/projects/2. 용산파크타워/6.jpg',
      '/assets/projects/2. 용산파크타워/7.jpg'
    ],
  ...
  },
  {
    ...
    title: '당산반도유보라',
    category: 'Residential',
    imageUrl: '/assets/projects/3. 당산반도유보라/2.jpg',
    galleryUrls: [
      '/assets/projects/3. 당산반도유보라/1.jpg',
      '/assets/projects/3. 당산반도유보라/2.jpg',
      '/assets/projects/3. 당산반도유보라/3.jpg'
    ],
  ...
  },
  {
    ...
    title: '도곡렉슬',
    category: 'Residential',
    imageUrl: '/assets/projects/4. 도곡렉슬/1.jpg',
    galleryUrls: [
      '/assets/projects/4. 도곡렉슬/1.jpg',
      '/assets/projects/4. 도곡렉슬/2.jpg',
      '/assets/projects/4. 도곡렉슬/3.jpg',
      '/assets/projects/4. 도곡렉슬/4.jpg',
      '/assets/projects/4. 도곡렉슬/5.jpg'
    ],
  ...
  },
  {
    ...
    title: '창전삼성래미안',
    category: 'Residential',
    imageUrl: '/assets/projects/5. 창전삼성래미안/2.jpg',
    galleryUrls: [
      '/assets/projects/5. 창전삼성래미안/1.jpg',
      '/assets/projects/5. 창전삼성래미안/2.jpg',
      '/assets/projects/5. 창전삼성래미안/3.jpg',
      '/assets/projects/5. 창전삼성래미안/4.jpg'
    ],
