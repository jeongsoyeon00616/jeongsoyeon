...
const STEPS = [
  {
    title: '공간 분석',
    subtitle: '평면도부터 동선까지, 당신의 하루를 관찰합니다',
  ...
  {
    title: '소재 큐레이션',
    subtitle: '이탈리아산 대리석부터 국내 장인 목재까지, 품격 있는 마감재를 직접 선별합니다',
  ...
  {
    title: '3D 시뮬레이션',
    subtitle: '포토리얼 렌더링으로 완공 전 공간을 미리 경험합니다',
  ...
  {
    title: '디테일 완성',
    subtitle: '조명 각도, 소품 배치, 컬러 밸런스. 마지막 1%까지 점검합니다',
