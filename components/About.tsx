        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-start">
          ...
          <div className="lg:col-span-6">
            ...
            <h3 className="text-5xl md:text-6xl font-serif text-[#1a1a1a] mb-12 leading-tight">
              Aesthetics of <br/>
              <span className="italic">Fluidity.</span>
            </h3>
            ...
            <div className="mt-20 space-y-12">
               <div>
                <h4 className="text-[11px] uppercase tracking-widest text-gray-400 mb-6 font-bold">Academic Background</h4>
          ...
          <div className="lg:col-span-6 space-y-16">
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -left-10 bg-charcoal p-10 text-white hidden xl:block shadow-2xl">
                <p className="text-[10px] uppercase tracking-[0.4em] text-gold mb-3">Lead Designer</p>
                <h4 className="text-3xl font-serif tracking-tight">Jeong Soyeon</h4>
                <div className="w-12 h-[1px] bg-gold mt-6"></div>
              </div>
            </div>

            <div className="bg-[#f9f9f9] p-12">
              <h4 className="text-[11px] uppercase tracking-widest text-gray-400 mb-10 font-bold">Technical Precision</h4>
